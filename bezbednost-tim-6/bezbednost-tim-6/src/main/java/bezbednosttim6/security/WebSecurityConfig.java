...
public class WebSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
	    ...
	    http.authorizeRequests()
	        ...
	        .requestMatchers("/api/user/register", "/api/user/login/first","/api/user/login/second", "/api/user/loginWithGoogle", "/api/user/activate/*", "/api/user/activate/resend/*", "/api/user/resetPassword", "/api/user/refreshToken", "/api/user/renewPassword", "/api/user/recaptcha").permitAll()
