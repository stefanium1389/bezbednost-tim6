...
//        http.csrf().disable();
        ...
        .requestMatchers("/api/user/register","/api/user/login","/api/user/activate/*","/api/user/activate/resend/*","/api/user/resetPassword","/api/user/refreshToken").permitAll()		// /auth/**
