...
//        http.csrf().disable();
        ...
        .requestMatchers("/api/user/register","/api/user/login","/api/user/loginWithGoogle","/api/user/activate/*","/api/user/activate/resend/*","/api/user/resetPassword","/api/user/refreshToken", "/api/user/renewPassword").permitAll()		// /auth/**
